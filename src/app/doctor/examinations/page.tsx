        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {appointments.map((app) => (
              <Link
                href={`/doctor/examinations/${app.id}`}
                key={app.id}
                className="block"
              >
                <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg hover:border-blue-500 border border-transparent transition-all duration-300 cursor-pointer">
